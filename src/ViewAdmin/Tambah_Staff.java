...
//        tambah
        ...
        tambah.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                s.setShift(cs.parseStaffShiftToInt(textfieldShift.getText()));
                s.setGaji(Integer.valueOf(textfieldGaji.getText()));
                s.setTanggalKerja(LocalDate.parse(textfieldTglAwalKerja.getText()));
                s.setIdCabang(Integer.valueOf(textfieldIdCabangKerja.getText()));

                LocalDate x = LocalDate.MIN;
                boolean get = true;
                try {
                    x = LocalDate.parse(textfieldTglAwalKerja.getText());
                    x = LocalDate.parse(textfieldTTL.getText());
                } catch (Exception ec) {
