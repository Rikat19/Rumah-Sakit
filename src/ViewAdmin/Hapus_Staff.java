...
//        });
        ...
        cari.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Staff s = cs.getStaffDariIdStaff(Integer.valueOf(textfieldID.getText()));
                namaPasien.setText("Nama: " + s.getNama());
                cabangKerja.setText("Cabang: " + c.getCabangDariId(s.getIdCabang()).getNama());
                tugasStaff.setText("Tugas: " + s.getTugas());
                // cari
            }
        });
        // result box
        ...
        hapus.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cs.hapusStaffDariId(Integer.valueOf(textfieldID.getText()));
